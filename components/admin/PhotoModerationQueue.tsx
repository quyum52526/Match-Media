  ...
  return (
    <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {photos.map((photo) => (
        ...
        >
          <div className="aspect-[3/4] w-full bg-charcoal/5">
          ...
          <div className="space-y-3 p-3">
            <div className="min-w-0">
              ...
              <p className="truncate font-sans text-xs text-charcoal/50">
                {photo.ownerEmail}
              </p>
            ...
            {rejectingId === photo.id ? (
              <div className="space-y-2">
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-charcoal/15 px-2.5 text-sm outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100"
                />
